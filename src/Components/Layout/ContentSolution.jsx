      ...
      <div className=" relative">
        <div className="lg:flex justify-center items-start lg:space-x-[60px]">
          ...
          <div className="lg:-mt-0 mt-3">
            ...
            <div className="rounded-gradient-border p-[1px]  rounded-[30px] lg:mt-5 mt-5 transition-all">
              <a href="#contactus">
                <div className="bg-white transition-all rounded-[30px] mid hover:text-white ">
                  <button className="multiverse-text2 font-semibold rounded-[30px] transition-all  text-[20px] py-1 px-3 ">
                    Contact Us
                  </button>
                </div>
              </a>
